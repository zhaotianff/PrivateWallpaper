...
#define PRIVATE_TYPE_INSTALL 0
#define PRIVATE_TYPE_UNINSTALL 1
#define PRIVATE_TYPE_USERINIT 2

#define PRIVATE_ADMIN_TASK_EXE_NAME L"PrivateWallpaper.AdminTask.exe"
